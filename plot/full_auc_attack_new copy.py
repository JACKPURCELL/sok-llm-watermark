...
for i, watermark_type in enumerate(watermark_types):
    ...
    clean_data_list = read_file(f'~/sok-llm-watermark/runs/token_200/{watermark_type}/c4/opt/gen_table_w_metrics.jsonl')
...
# 计算 ROC 曲线
    ...
    for j, attack in enumerate(attacks):
        ...
        try:
            data_list = read_file(f'~/sok-llm-watermark/runs/token_200/{watermark_type}/c4/opt/{attack}/gen_table_w_metrics.jsonl')
        except:
