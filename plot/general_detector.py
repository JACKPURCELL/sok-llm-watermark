...
# Define a range of orange shades (light to dark for visual differentiation)
orange_shades = ['#ffcc99', '#ffb366', '#ff9933', '#ff8000']
...
fig, axs = plt.subplots(2, cols, figsize=(cols*6, 12))  # Adjust the size of the figure
...
for idx, (watermark_type, values) in enumerate(data.items()):
    ...
    for i, coord in enumerate(coords):
        ...
        ax.text(coord[0] + size/2, coord[1] + size/2, f'{percentages[i]}', ha="center", va="center", fontsize=10, weight='bold')
