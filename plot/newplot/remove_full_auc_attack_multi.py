...
watermark_types = ["john23","xuandong23b","aiwei23","rohith23","aiwei23b","xiaoniu23","scott22"]
replace_dict = {
    "john23": "TGRL",
    "xuandong23b": "UG",
    "aiwei23": "UPV",
...
# ContractionAttack_multiple/ExpansionAttack   ContractionAttack_multiple/LowercaseAttack  ContractionAttack_multiple/MisspellingAttack  ContractionAttack_multiple/swap  ContractionAttack_multiple/synonym-0.4  ContractionAttack_multiple/TypoAttack
# swap_multiple/ContractionAttack  swap_multiple/ExpansionAttack   swap_multiple/LowercaseAttack  swap_multiple/MisspellingAttack    swap_multiple/synonym-0.4  swap_multiple/TypoAttack
# synonym-0.4_multiple/ContractionAttack  synonym-0.4_multiple/ExpansionAttack   synonym-0.4_multiple/LowercaseAttack  synonym-0.4_multiple/MisspellingAttack  synonym-0.4_multiple/swap    synonym-0.4_multiple/TypoAttack
attacks = [
...
plt.tight_layout()
plt.savefig(f'./plot/newplot/output/full_roc_token_200_{dataset}_{model}_multi.pdf')
...
# 保存图形
plt.savefig(f'./plot/newplot/output/full_roc_value_token_200_{dataset}_{model}_multi.pdf')


print("=======TPR===========")
# 创建子图2
fig3, axs3 = plt.subplots(5, 4, figsize=(40, 40))
axs3 = axs3.flatten()

with open(f'./plot/newplot/output/output_{dataset}_{model}_multi.txt', 'w') as f:

    for watermark in watermark_types:
        for attack in attacks:
            f.write(f'{watermark},{attack},{tpr_dict[watermark][attack]},{dataset}\n')
        f.write(f'{watermark},{"CLEAN"},{tpr_dict[watermark]["CLEAN"]},{dataset}\n')
...
# 保存图形
plt.savefig(f'./plot/newplot/output/full_roc_value_token_200_tpr001111_{dataset}_{model}_multi.pdf')
