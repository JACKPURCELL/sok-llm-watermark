...
watermark_types = ["john23", "xuandong23b", "aiwei23", "rohith23", "xiaoniu23",  "scott22", "aiwei23b"]
replace_dict = {
    "john23": "TGRL",
    "xuandong23b": "UG",
    "aiwei23": "UPV",
...
fig, axs = plt.subplots(1, 3, figsize=(21, 7))  # 创建两个子图
    ...
    for k, file_path in enumerate(file_paths):
        ...
        with open(file_path, 'r') as f:
            for line in f:
                ...
                length_limit = 30 if 'token_50' in file_path else 100
...
plt.tight_layout()
plt.savefig(f'./plot/newplot/output/auc_clean_model_{dataset}_temp.pdf')
...
plt.savefig(f'./plot/newplot/output/auc_clean_model_fpr001_{dataset}_temp.pdf')