...
attacks = [
          "synonym-0.4", "MisspellingAttack", "TypoAttack","swap",
  "copypaste-1-10", "copypaste-3-10","copypaste-1-25","copypaste-3-25",
"ContractionAttack", "ExpansionAttack", "LowercaseAttack",
   "dipper_l20_o0","dipper_l40_o0","dipper_l60_o0", "dipper_l60_o20","dipper_l60_o40","translation",
           ]    
...
plt.tight_layout()
plt.savefig('./plot/newplot/output/casual_3.pdf', bbox_inches='tight')
print("./plot/newplot/output/casual_3.pdf")