...
def get_output_file(args, model, start, end):
    ...
    output_file += f"{args.method}_iters={args.num_iters}_{attack_str}_lambda_sim={args.lam_sim}_lambda_perp={args.lam_perp}_emblayer={args.embed_layer}_{args.constraint}.pth"
