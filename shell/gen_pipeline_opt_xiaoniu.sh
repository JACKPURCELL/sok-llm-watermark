...
echo "start $watermark_type"
    ...
    echo "start $model"s
        ...
        CUDA_VISIBLE_DEVICES="$gpus" nohup python watermark_reliability_release/evaluation_pipeline.py --overwrite_output_file True --watermark "$watermark_type" --wandb_project xiaoniu_new --run_name eva-c4-"$watermark_type"-"$model"  --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model" --overwrite_args True &
    echo "finish $model"
