...
for watermark_type in "${watermark_types[@]}"; do
    ...
    for model in "${models[@]}"; do
        ...
        #     # 对每个元素执行python命令
        #     python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name "$attack_type"-attack-"$watermark_type"-c4 --input_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams  --output_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams/"$attack_type" --attack_method "$attack_type"
        #  done


        # #synonym
        #  for synonym_prob in "${synonym_probs[@]}"; do
        #     python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name synonym-"$synonym_prob"-attack-"$watermark_type"-c4 --input_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams  --output_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams/synonym-"$synonym_prob" --attack_method synonym --synonym_p "$synonym_prob"
        #  done
        ...
        #    python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name helm-"$helm_attack_method"-attack-"$watermark_type"-c4 --input_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams  --output_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams/"$helm_attack_method" --attack_method helm --helm_attack_method "$helm_attack_method"
        # done
        ...
        #CUDA_VISIBLE_DEVICES="$gpus" python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name dipper-attack-"$watermark_type"-c4 --input_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams  --output_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-"$beams"beams/dipper_l60_o20 --attack_method dipper --lex 60 --order 20
