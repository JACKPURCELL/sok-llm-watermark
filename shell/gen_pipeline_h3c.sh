...
echo "start $watermark_type"
    ...
    echo "start $model"s
        ...
        CUDA_VISIBLE_DEVICES="$gpus" python watermark_reliability_release/evaluation_pipeline.py --overwrite_output_file True --watermark "$watermark_type" --dataset_name hc3 --wandb_project hc3 --run_name eva-hc3-"$watermark_type"-"$model"  --input_dir ~/sok-llm-watermark/runs/token_200/"$watermark_type"/hc3/"$model" --overwrite_args True 
    echo "finish $model"
