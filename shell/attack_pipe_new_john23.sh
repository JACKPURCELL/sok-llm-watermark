...
for watermark_type in "${watermark_types[@]}"; do
    ...
    for model in "${models[@]}"; do
        ...
        #      # 对每个元素执行python命令
        #      python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name "$attack_type"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"/"$attack_type" --attack_method "$attack_type"
        #   done


        # #synonym
        #  for synonym_prob in "${synonym_probs[@]}"; do
        #     python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name synonym-"$synonym_prob"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"/synonym-"$synonym_prob" --attack_method synonym --synonym_p "$synonym_prob"
        #  done

        # # #copypaste
        for cp_attack_insertion_len in "${cp_attack_insertion_lens[@]}"; do
            python watermark_reliability_release/attack_pipeline.py --cp_attack_type single-single --wandb False --overwrite_args True  --run_name copypaste-1-"$cp_attack_insertion_len"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/new"$model"/copypaste-1-"$cp_attack_insertion_len" --attack_method copy-paste --cp_attack_insertion_len "$cp_attack_insertion_len"
        ...
        #    python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name helm-"$helm_attack_method"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"/"$helm_attack_method" --attack_method helm --helm_attack_method "$helm_attack_method"
        # done

        # dipper need 48gb memory
        # for dipper_lex in "${dipper_lexs[@]}"; do
        #    CUDA_VISIBLE_DEVICES="$gpus" python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name dipper-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"/dipper_l"$dipper_lex"_o0 --attack_method dipper --lex "$dipper_lex" 
        # done
        # CUDA_VISIBLE_DEVICES="$gpus" python watermark_reliability_release/attack_pipeline.py --wandb False --overwrite_args True  --run_name dipper-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/"$token"/"$watermark_type"/c4/"$model"/dipper_l60_o20 --attack_method dipper --lex 60 --order 20
