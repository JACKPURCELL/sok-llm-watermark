    ...
    for model in "${models[@]}"; do
        ...
        # done
         ...
         for attack_type in "${attack_types[@]}"; do
             ...
             python watermark_reliability_release/attack_pipeline.py --overwrite_args True --wandb_project gen-c4-v2.0-500-llama --run_name "$attack_type"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"/"$attack_type" --attack_method "$attack_type"
         done


        # #synonym
         for synonym_prob in "${synonym_probs[@]}"; do
             python watermark_reliability_release/attack_pipeline.py --overwrite_args True --wandb_project gen-c4-v2.0-500-llama --run_name synonym-"$synonym_prob"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"/synonym-"$synonym_prob" --attack_method synonym --synonym_p "$synonym_prob"
         done
        ...
        for helm_attack_method in "${helm_attack_methods[@]}"; do
            python watermark_reliability_release/attack_pipeline.py --overwrite_args True --wandb_project gen-c4-v2.0-500-llama --run_name helm-"$helm_attack_method"-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"/"$helm_attack_method" --attack_method helm --helm_attack_method "$helm_attack_method"
        done


        # # # CUDA_VISIBLE_DEVICES=1 python watermark_reliability_release/attack_pipeline.py --overwrite_args True --wandb_project gen-c4-v2.0-500-llama --run_name dipper-attack-"$watermark_type"-c4 --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"  --output_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"/dipper_l60_o20 --attack_method dipper --lex 60 --order 20
        echo "finish $model"
    done
