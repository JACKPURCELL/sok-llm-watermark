...
echo "start $watermark_type"
    ...
    echo "start $model"
        ...
        echo "start $temp"
            ...
            CUDA_VISIBLE_DEVICES="" nohup python watermark_reliability_release/evaluation_pipeline.py --overwrite_output_file True --watermark "$watermark_type" --wandb_project reeva-temp --run_name eva-c4-"$watermark_type"-"$model"-temp"$temp"  --input_dir /home/ljc/sok-llm-watermark/runs/token_200/"$watermark_type"/c4/"$model"-temp"$temp" --overwrite_args True &
