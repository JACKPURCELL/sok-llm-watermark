...
if __name__ == "__main__":
    ...
    methodS = ["aiwei23", "john23",  "rohith23", "xiaoniu23", "xuandong23b","aiwei23b","scott22"]
    no_atk = {}
    no_eva = {}
    for method in methodS:
        for model in modelS:    
            for attack in attackS:
                file_path = "/home/jkl6486/sok-llm-watermark/runs_server3/token_200/" + method + "/c4/" + model + "/" + attack + "/"
