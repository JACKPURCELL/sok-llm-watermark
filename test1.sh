...
CUDA_VISIBLE_DEVICES=1,2,3 nohup python watermark_reliability_release/generation_pipeline.py --watermark lean23 --dataset_name hc3 --run_name gen-hc3-lean23 --model_name_or_path meta-llama/Llama-2-7b-chat-hf --min_generations 1000 &
...
CUDA_VISIBLE_DEVICES=1,2,3 nohup python watermark_reliability_release/generation_pipeline.py --watermark lean23 --dataset_name c4 --run_name gen-c4-lean23 --model_name_or_path meta-llama/Llama-2-7b-chat-hf --min_generations 1000 &



CUDA_VISIBLE_DEVICES=1,2,3 nohup python watermark_reliability_release/generation_pipeline.py --watermark aiwei23 --dataset_name hc3 --run_name test-gen-aiwei23 --model_name_or_path meta-llama/Llama-2-7b-chat-hf --min_generations 1000 &
