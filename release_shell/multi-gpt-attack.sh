...
models=("llama")
# num_beams=( "4" "8")
dirs=("exp_2_gptattack_1" "exp_2_gptattack_2" "exp_2_gptattack_3" "exp_2_gptattack_4" "exp_2_gptattack_5" )
# dirs=( "exp_2_gptattack_2" "exp_2_gptattack_3" "exp_2_gptattack_4" "exp_2_gptattack_5" )
...
for index in "${!dirs[@]}"; do
  ...
  python watermark_reliability_release/multi_attack_gpt.py --exp "$dir"
