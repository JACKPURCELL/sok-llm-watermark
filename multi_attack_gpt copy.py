...
#             try:
#                 if length>180 and  data["w_wm_output_prediction"]:
...
#     dir_path = f'/home/jkl6486/sok-llm-watermark/runs_server3/token_200/{watermark_type}/{dataset}/llama/exp_3_gptattack_base_0'

#     # Create the directory
#     os.makedirs(dir_path, exist_ok=True)

#         # Open the file in write mode
#     with open(f'/home/jkl6486/sok-llm-watermark/runs_server3/token_200/{watermark_type}/{dataset}/llama/exp_3_gptattack_base_0/gen_table.jsonl', 'w') as f:
...
#     dst_file = f'/home/jkl6486/sok-llm-watermark/runs_server3/token_200/{watermark_type}/{dataset}/llama/exp_3_gptattack_base_0/gen_table_meta.json'
