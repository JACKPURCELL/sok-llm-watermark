...
def main(args):
    ...
    match args.watermark:
        ...
        case 'lean23':
            ...
            # dill.dump(watermark_processor.watermark_processor, open("/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/lean23/processor/lean23_"+str(args.model_name_or_path).replace("/","")+".pkl", "wb"))
            ...
            '''args_list = [args.lean_delta, 
                         ...
                         args.lean23_top_k, 
                         args.repeat_penalty]
            dill.dump(args_list, open("/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/lean23/processor/lean23_args.pkl", "wb"))
            dill.dump(watermark_processor, open("/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/lean23/processor/lean23.pkl", "wb"))'''
        ...
        case 'aiwei23b':
            # args.embedding_input_path = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "data/sts/train.jsonl")
            args.embedding_output_path = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "data/embeddings/train_embeddings.txt")
            # args.aiwei23b_model_path = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "model/compositional-bert-large-uncased")
            args.aiwei23b_output_model = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "model/transform_model_cbert.pth")
            args.mapping_output_dir = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "data/mappings/")
            args.transform_model = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "model/transform_model_cbert.pth")
            # args.embedding_model = os.path.join("/data/jiacheng/sok-llm-watermark/",args.output_dir , "model/compositional-bert-large-uncased")
...
if __name__ == "__main__":
    ...
    match args.watermark:
        ...
        case 'aiwei23b':
            parser.add_argument("--embedding_input_path", type=str, default="/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/sts/train.jsonl")
            # parser.add_argument("--embedding_output_path", type=str, default="/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/embeddings/train_embeddings.txt")
            parser.add_argument("--aiwei23b_model_path", type=str, default="/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/model/compositional-bert-large-uncased")
            parser.add_argument("--aiwei23b_size", type=int, default=2000)
            # parser.add_argument("--aiwei23b_output_model", type=str, default="/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/model/transform_model_cbert.pth")
            ...
            parser.add_argument("--mapping_length", type=int, default=152064)
            # parser.add_argument("--mapping_output_dir", type=str, default="/data/jiacheng/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/mappings/")
