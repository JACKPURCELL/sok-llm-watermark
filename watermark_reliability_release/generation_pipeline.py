...
if __name__ == "__main__":
    ...
    match args.watermark:
        ...
        case 'aiwei23b':
            parser.add_argument("--embedding_input_path", type=str, default="/home/ljc/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/sts/train.jsonl")
            parser.add_argument("--embedding_output_path", type=str, default="/home/ljc/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/embeddings/train_embeddings.txt")
            ...
            parser.add_argument("--mapping_output_dir", type=str, default="/home/ljc/sok-llm-watermark/watermark_reliability_release/watermarks/aiwei23b/data/mappings/")
