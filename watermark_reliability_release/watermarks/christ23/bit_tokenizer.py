...
class Binarization:
    def __init__(self, tokenizer, devices="cpu", use_huffman_coding=False, huffman_coding_path='~/sok-llm-watermark/watermark_reliability_release/watermarks/christ23/static_data/encoding.tsv', corpus=None, save_path="~/sok-llm-watermark/watermark_reliability_release/watermarks/christ23/static_data/huffman_coding.tsv"):
