...
def save_false_idx(data, attack_epoch, method):
    ...
    if attack_epoch == -1:
        save_path = "/home/jkl6486/sok-llm-watermark/runs/token_200/" + method + "/c4/opt/dipper_l" + lex_len + "_o0/escape/gen_table_attacked.jsonl"
