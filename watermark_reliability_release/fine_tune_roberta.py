...
parser.add_argument('--train_path', type=str, default="/home/jkl6486/sok-llm-watermark/runs/token_200/xuandong23b/c4/opt/dipper_l40_o0/gen_table_w_metrics.jsonl")
parser.add_argument('--output_path', type=str, default="/home/jkl6486/sok-llm-watermark/runs/token_200/xuandong23b/c4/opt/dipper_l40_o0/dipp_roberta_finetuned_baseline")
...
parser.add_argument('--method_name', type=str,default="xuandong23b")
...
with open(args.train_path, "r") as f:
    for line in f:
        ...
        generations.append(data["baseline_completion"])
        labels.append(0)
...
full_dataset_2=dataset(generations_2, labels_2)
...
if args.train:
    ...
    print(metrics)
if args.eva_attack:
    res = trainer.predict(full_dataset_2)
