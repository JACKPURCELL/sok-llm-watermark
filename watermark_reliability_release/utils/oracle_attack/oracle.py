...
class Oracle:
    def __init__(self, check_quality=False, choice_granuality=5, use_chat_arena_prompt=False, cache_dir='/data/jc/hf/hub') -> None:
        self.init_score = -1
        # Additional attributes to store query and response
        self.query = None
        self.response = None
    ...
    def set_query_and_response(self, query, response):
        self.query = query
