...
with open('~/sok-llm-watermark/runs/token_200/john23/c4/llama/dipper_l40_o0/roberta_finetuned2/gpt_saved.jsonl', 'w') as file:
	for idx in range(len(generations)):
		item = {"output": generations[idx], "label": labels[idx]}
		file.write(json.dumps(item) + '\n')

# with open('~/sok-llm-watermark/runs/token_200/john23/c4/llama/dipper_l40_o0/roberta_finetuned2/gpt_saved.jsonl', 'r') as file:
# 	for line in file:
# 		data = json.loads(line)
