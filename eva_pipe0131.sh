...
echo "start $watermark_type"
    ...
    echo "start $model"
        ...
        #    CUDA_VISIBLE_DEVICES=1  python watermark_reliability_release/evaluation_pipeline.py --only_attack_zscore True   --overwrite_output_file True --watermark "$watermark_type" --run_name helm-"$helm_attack_method"-neweva-"$watermark_type"-c4-"$model"  --input_dir /home/jkl6486/sok-llm-watermark/runs/token_100/"$watermark_type"/c4/"$model"/"$helm_attack_method"  --wandb_project gen-c4-v2.0-100tokens-500    --lower_tolerance_T 50  --upper_tolerance_T 100
        #done
