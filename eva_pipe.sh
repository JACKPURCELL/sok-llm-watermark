...
echo "start $watermark_type"
    ...
    echo "start $model"
        ...
        for dipper_lex in "${dipper_lexs[@]}"; do
            CUDA_VISIBLE_DEVICES=0,2 python watermark_reliability_release/evaluation_pipeline.py --only_attack_zscore True --wandb_project gen-c4-v2.0-100tokens-500 --overwrite_output_file True --watermark "$watermark_type" --run_name dipper-neweva-"$watermark_type"-c4-"$model"-dipper_l"$dipper_lex"_o0   --input_dir /home/ljc/sok-llm-watermark/runs/token_100/"$watermark_type"/c4/"$model"/dipper_l"$dipper_lex"_o0 
        done
        CUDA_VISIBLE_DEVICES=0,2 python watermark_reliability_release/evaluation_pipeline.py --only_attack_zscore True --wandb_project gen-c4-v2.0-100tokens-500 --overwrite_output_file True --watermark "$watermark_type" --run_name dipper-neweva-"$watermark_type"-c4-"$model"-dipper_l60_o20   --input_dir /home/ljc/sok-llm-watermark/runs/token_100/"$watermark_type"/c4/"$model"/dipper_l60_o20 
